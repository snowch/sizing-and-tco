...
table beats an interval, and the one sentence that has to go beside the number — what it leaves
out. Everything before this chapter exists to earn the right to say it.
