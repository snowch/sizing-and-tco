...
One chapter, and it decides whether the previous twenty-one were worth the effort. A model nobody
...
table beats an interval, and the one sentence that has to go beside the number, saying what it
leaves out. Everything before this chapter exists to earn the right to say it.

It is also the one chapter in the book arguing from experience rather than from a stamped result,
and it says so.
