...
**[ch12 · Monte Carlo](#monte-carlo)** gives you the whole technique, from first principles, in
about as much code as fits on a page. It assumes you can read code and do arithmetic, and nothing
at all about statistics. Four words of vocabulary arrive in it, each because a model has just
raised a question that needs it.

**[ch13 · Correlation and convergence](#correlation-and-convergence)** picks up the two things the
