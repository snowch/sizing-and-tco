...
An interval is a description of a problem. This part is the only actionable thing available, and
then the limit of everything the book has built.

[ch19](#which-input-is-the-answer) ranks the inputs by how far each one moves the answer, and then
computes the question that follows a ranking: what measuring it would buy, as a ceiling. Two
results there are worth the chapter on their own — that the book's most carefully measured
