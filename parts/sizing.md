...
and the number nobody computes — how badly the neglected one loses, in the cases where it wins.
...
topic: a number you cannot defend, and the sense that you cannot defend it.
