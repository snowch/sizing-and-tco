...
**[ch04 · Little's law](#littles-law)** is the one relationship that needs no assumptions at all,
and can therefore explain nothing.

**[ch05 · Queueing, and the knee](#queueing-and-the-knee)** buys a mechanism and pays for it in
...
**[ch06 · When adding servers stops helping](#when-adding-servers-stops-helping)** is the obvious
...
**[ch07 · Regime changes](#regime-changes)** is the argument the other three have been assembling:
