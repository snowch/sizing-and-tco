...
@container (min-width: 860px) { iframe.viewer[src*="demand_inputs_single"] { height: 380px; } }
@container (min-width: 860px) { iframe.viewer[src*="demand_inputs_initial"] { height: 420px; } }
@container (min-width: 860px) { iframe.viewer[src*="demand_inputs_all"] { height: 480px; } }
@container (min-width: 860px) { iframe.viewer[src*="demand_horizon_exponent"] { height: 450px; } }
@container (min-width: 1101px) { iframe.viewer { height: 812px; } }
@container (min-width: 1101px) { iframe.viewer[src*="demand_inputs_single"] { height: 380px; } }
@container (min-width: 1101px) { iframe.viewer[src*="demand_inputs_initial"] { height: 420px; } }
@container (min-width: 1101px) { iframe.viewer[src*="demand_inputs_all"] { height: 480px; } }
@container (min-width: 1101px) { iframe.viewer[src*="demand_horizon_exponent"] { height: 450px; } }
