...
<main>
  ...
  <section id="canvas">
    ...
    <div class="legend">
      <span><i style="background:var(--input);border:1px solid var(--input-edge)"></i>input (given)</span>
      <span><i class="decision" style="background:var(--input);border:1px solid var(--input-edge)"></i>input you choose</span>
      <span><i style="background:var(--derived);border:1px solid var(--derived-edge)"></i>derived (worked out)</span>
