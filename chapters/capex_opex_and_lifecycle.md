---
title: "Capex, opex and the lifecycle [DRAFT]"
short_title: "ch15 Capex, opex and the lifecycle"
---

(capex-opex-and-lifecycle)=
# ch15 · Capex, opex and the lifecycle [DRAFT]
...
[To write: each problem is a stub under `tests/capex_opex_and_lifecycle/` with a test that passes only when
