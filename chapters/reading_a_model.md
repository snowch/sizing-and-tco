---
title: "Reading a model [DRAFT]"
short_title: "ch01 Reading a model"
---

(reading-a-model)=
# ch01 · Reading a model [DRAFT]
...
| **What it produces** | A walk through every node kind against the storage model, and the DSL's own reference scenario. |
...
[To write: each problem is a stub under `tests/reading_a_model/` with a test that passes only when
