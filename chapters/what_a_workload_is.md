---
title: "What a workload is [DRAFT]"
short_title: "ch02 What a workload is"
---

(what-a-workload-is)=
# ch02 · What a workload is [DRAFT]
...
| **What it produces** | The workload table for both reference models, derived from their input nodes. |
:::
...
[To write: each problem is a stub under `tests/what_a_workload_is/` with a test that passes only when
