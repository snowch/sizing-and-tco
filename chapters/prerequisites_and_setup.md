---
title: "Prerequisites and setup [DRAFT]"
short_title: "ch00 Prerequisites and setup"
---

(prerequisites-and-setup)=
# ch00 · Prerequisites and setup [DRAFT]
...
|---|---|
| **Prerequisites** | none |
| **What it produces** | The setup check's own output, as a stamped result. |
:::

## The question

What do I need installed, and how do I check that a model in this book still says what it says here?
...
[To write: each problem is a stub under `tests/prerequisites_and_setup/` with a test that passes only when
