---
title: "Unit economics [DRAFT]"
short_title: "ch17 Unit economics"
---

(unit-economics)=
# ch17 · Unit economics [DRAFT]
...
| | |
|---|---|
| **Prerequisites** | [ch16](#power-first) |
| **What it produces** | Cost per usable TB-month from the storage model, and what its denominator assumes. |
...
[To write: each problem is a stub under `tests/unit_economics/` with a test that passes only when
