---
title: "The five-year model [DRAFT]"
short_title: "ch18 The five-year model"
---

(the-five-year-model)=
# ch18 · The five-year model [DRAFT]
...
| **What it produces** | Both models joined at the unit price, end to end. |
...
[To write: each problem is a stub under `tests/the_five_year_model/` with a test that passes only when
