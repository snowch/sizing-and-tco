---
title: "When adding servers stops helping [DRAFT]"
short_title: "ch07 When adding servers stops helping"
---

(when-adding-servers-stops-helping)=
# ch07 · When adding servers stops helping [DRAFT]
...
| **What it produces** | A universal scalability law fit, and what it predicts for the observability ingest tier. |
:::

## The question

How far does a system scale, and how would you find out from the two measurements you actually have?
...
[To write: each problem is a stub under `tests/when_adding_servers_stops_helping/` with a test that passes only when
